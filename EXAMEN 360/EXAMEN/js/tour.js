...
infospot2.element.innerHTML = '<div style="width:50px; height:auto; border-radius: 5px;"><img src="EXAMEN/imagenes/rojo.png" type="img"></></div>';
...
infospot3.element.innerHTML= '<div style="width:50px; height:auto; border-radius: 5px;"><img src="EXAMEN/imagenes/naranjapastel.png"type="img"></></div>';
...
infospot5.element.innerHTML= '<div style="width:50px; height:auto; border-radius: 5px;"><img src="EXAMEN/imagenes/rosapastel.png"type="img"></></div>';
...
//ZONA JUGUETES STEAM
var infospot8 = new PANOLENS.Infospot(150,'EXAMEN/imagenes/VIDEO.jpg');
infospot8.position.set(-360,101,500);
infospot8.element.innerHTML = '<div class="" style=""><iframe width="720" height="480" src="https://www.youtube.com/watch?v=NDUK0sVccwU"></iframe></div>';
...
infospot9.element.innerHTML = '<div style="width:50px; height:auto; border-radius: 5px;"><img src="EXAMEN/imagenes/stem.jpg" type="img"></></div>';
...
infospot10.addHoverElement = '<div style="width:10px; height:auto; border-radius: 5px;"><img src="EXAMEN/imagenes/JM.jpg" type="img"></></div>';
...
infospot11.addHoverText('LIBROS',100);
infospot11.position.set(-500,179,-200);
infospot11.element.innerHTML = '<div style="width:50px; height:auto; border-radius: 5px;"><img src="EXAMEN/imagenes/LIBROS.jpg" type="img"></></div>';
...
infospot12.addEventListener('click', function() {
    window.open("EXAMEN/pdf/BEBES.pdf", "_blank");
});
...
infospot13.addHoverText('AREA DE CAJAS',100);
